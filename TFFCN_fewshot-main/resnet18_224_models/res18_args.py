...
def parse_args(script):
    ...
    parser.add_argument('--classifier' , default='centroid',   help='LR/SVM//centroid')
    ...
    parser.add_argument('--hallucinator_type', default='tensor', type=str, help='vector/tensor')  #default='vector'
    ...
    if script == 'train':
        ...
        parser.add_argument('--stop_epoch'  , default=100, type=int, help ='Stopping epoch') #for meta-learning methods, each epoch contains 100 episodes. The default epoch number is dataset dependent. See train.py  default=100
        ...
        parser.add_argument('--test_batch_size' , default=64, type=int, help='batch size ')  #default=64
        ...
        parser.add_argument('--vae_path', type=str, default='/gen_training', help ='')
